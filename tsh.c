...
/*
 *bg_job - restart a stopped job and put it to background
 */
void bg_job(struct cmdline_tokens* tok)
{
	pid_t pid;
...
/*
 *redirect - change the discriptor table to implement IO redirection
 */
void redirect(char* infile, char* outfile)
{
	int fd;
